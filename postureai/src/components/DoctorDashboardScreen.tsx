      ...
      >
        <GlassCard className="p-10 text-center">
          ...
          <h1 className="text-2xl font-black tracking-tight text-white mb-2">
            Doctor <span className="text-cyan-400">Dashboard</span>
          </h1>
          <p className="text-slate-400 text-sm mb-1">Signed in as</p>
          {displayName ? (
            <p className="text-white font-semibold mb-1 truncate">{displayName}</p>
          ) : null}
          <p className="text-cyan-200/90 font-medium mb-8 truncate">{email}</p>
          <NeonButton className="w-full mb-4" onClick={onContinue}>
